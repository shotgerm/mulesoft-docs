...
This release of Design Center includes bug fixes related to API design.

* Updated JS RAML Parser to v1.1.37.
...
* Fixed a bug that appears in IE 11.0.9 and Safari when using API Console to simulate calling an API created in the visual design mode.
* Publishing to Exchange now uses the updated project name.
* The same data is shown for default input and example IDs of properties of the Date type.

...
When you upgrade from the API Manager 1.x to API Manager 2.x, APIs are unclassified. Unclassified APIs reside in the unclassified environment. You need to classify any unclassified APIs to govern or otherwise manage the APIs as described in this procedure.

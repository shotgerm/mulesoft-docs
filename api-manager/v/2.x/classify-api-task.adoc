...
Prior to November 2017, in a hybrid server or CloudHub, API Manager tracked APIs using organization credentials. For tighter security, after migration to API Manager 2.x, you can choose to track APIs using environment credentials or you can continue to use organization credentials. MuleSoft recommends using environment credentials after you classify all your APIs.

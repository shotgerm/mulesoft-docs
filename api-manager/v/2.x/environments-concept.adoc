...
You need to classify an API to manage it. No downtime occurs when you classify an API if you use organization client credentials in the Mule wrapper.conf file or CloudHub property settings.

...
Mule applications can also store properties with encrypted values using secure configuration properties.
...
Mule applications can also be developed to store encrypted properties in secure configuration properties files. 
...
Encypted properties that are bundled with a Mule application inside a secure configuration properties file will not appear in the Runtime Manager Properties tab. In this way, the values are safely locked inside the Mule application. 
